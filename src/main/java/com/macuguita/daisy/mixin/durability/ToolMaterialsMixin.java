...
public class ToolMaterialsMixin {
    ...
    private static ToolMaterials daisy$rebalanceToolSpeedAndEnchantability(String name, int ordinal, int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient, Operation<ToolMaterials> original) {
        switch (name) {
            case "GOLD":
                miningSpeed = 8.0F;
                enchantability = 10;
