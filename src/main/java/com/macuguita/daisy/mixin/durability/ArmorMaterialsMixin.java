...
public class ArmorMaterialsMixin {
    ...
    private static ArmorMaterials daisy$rebalanceEquipmentEnchantability(String enumName, int ordinal, String name, int durabilityMultiplier, EnumMap protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier repairIngredientSupplier, Operation<ArmorMaterials> original) {
        switch (enumName) {
            case "GOLD":
                enchantability = 10;
                break;
