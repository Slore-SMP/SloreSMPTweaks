...
public class PlayerManagerMixin {
    ...
    private void daisy$wrapSelfSendPacket(ServerPlayNetworkHandler instance, Packet<?> packet,
    ...
    private void daisy$wrapBroadcastPacket(PlayerManager playerManager, Packet<?> packet,
                                           Operation<Void> original) {
        if (packet instanceof PlayerListS2CPacket listPacket) {
